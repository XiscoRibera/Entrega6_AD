...
- Usando el criterio del codo, nos quedaremos con $2$ o $3$ CPs
- Nos quedamos con 2 CPs ya que el análisis es junto a clustering que su representación es sobre 2 CPs.
</div>
...
### Cos2
<div style="font-size: 20pt;">
calidad de representación, realizaremos un gráfico de cos2
</div>
