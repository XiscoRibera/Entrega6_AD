...
Realicemos kmedoids con k=4 para comparar:

```{r}
pam_clusters_ <- pam(x = cX, k = 4, metric = "manhattan")

fviz_cluster(object = pam_clusters_, data = cX, ellipse.type = "t", geom = "point", repel =TRUE) +
  theme_bw() + 
  theme(legend.position = "none")
```
